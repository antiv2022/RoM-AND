...
#-------------------------------------------------------------------------------------------------
	...
	def doNewHuman( self, iNewPlayerID, iOldPlayerID ):
		print ("doNewHuman", iNewPlayerID, iOldPlayerID)
	...
	def onBeginPlayerTurn(self, argsList):
		...
		if iAutoPlay > 0 and iPlayer > game.getActivePlayer() and (not gc.getActivePlayer().isAlive() or iAutoPlay == 1):
			self.checkPlayer()
...
# Lemmy101 RevolutionMP edit
#-------------------------------------------------------------------------------------------------
				self.abdicateMultiCheck( self.playerID, numTurns = numTurns, voluntary = False )
#-------------------------------------------------------------------------------------------------
# END Lemmy101 RevolutionMP edit
#-------------------------------------------------------------------------------------------------   
